    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Datos Bancarios</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">Entidad Financiera</label>
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Tipo de Producto</label>
                ...
                <div class="form-group">
                  	<label for="address" class="col-sm-3 control-label">Numero Producto</label>
