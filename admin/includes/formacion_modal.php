    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                      ...
                      <select class="form-control" name="gender" id="gender" required>
                        ...
                        <option value="Male">Bachiller</option>
                        <option value="Female">Técnico</option>
                        <option value="Female">Tecnologo</option>
                        <option value="Female">Pregrado</option>
                        <option value="Female">Posgrado</option>
                        <option value="Female">Maestría</option>
                        <option value="Female">Doctorado</option>
                      </select>
                  	</div>
                </div>

                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Institución</label>
                  	<div class="col-sm-9">
                ...
                <div class="form-group">
                  	<label for="datepicker_add" class="col-sm-3 control-label">Fecha Grado</label>
                  	<div class="col-sm-9"> 
                      <div class="date">
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Título Obtenido</label>
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="lastname" name="lastname" required>
                  	</div>
                </div>
