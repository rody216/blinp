          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">Número de Procesos</label>
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Fecha Radificación</label>
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Clase</label>

                  	<div class="col-sm-9">
                    	<input type="number" class="form-control" id="lastname" name="lastname" required>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Estaus</label>
