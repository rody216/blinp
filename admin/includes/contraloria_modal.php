<!-- Add -->
<div class="modal fade" id="contraloria">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><b>Contraloria</b></h4>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Actualizar datos contraloria</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edt_correctivo" class="col-sm-3 control-label">Correctivo</label>

                    <div class="col-sm-9">
                    <input type="text" class="form-control" id="edt_correctivo" name="correctivo">

                    </div>
                </div>
                <div class="form-group">
                    <label for="edt-fecha" class="col-sm-3 control-label">Fecha</label>

                    <div class="col-sm-9">
                      <input type="date" class="form-control" id="edt-fecha" name="fecha">
                    </div>
                </div>
                <div class="form-group">
                    <label for="edt_obs" class="col-sm-3 control-label">Observaciones</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edt_obs" name="obs">
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
