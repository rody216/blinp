    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>ICTH</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">Tipo de Examen</label>

                  	<div class="col-sm-9">
                      <select class="form-control" name="gender" id="edit_gender">
                        <option selected id="gender_val"></option>
                        <option value="Male">Poligrafia</option>
                        <option value="Female">Visita Domiciliaria</option>
                        <option value="Female">Entrevista</option>
                        <option value="Female">Antecedentes</option>
                      </select>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Fecha</label>
                  	<div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Subir Archivo</label>
                    <div class="col-sm-9">
