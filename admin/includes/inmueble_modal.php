          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">Ciudad</label>
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Oficina</label>
                ...
                <div class="form-group">
                  	<label for="address" class="col-sm-3 control-label">Matricula</label>
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Direccion</label>
