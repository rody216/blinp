...
function Header()
{
    ...
    $this->Image('../../images/fondo_blin.png',25,5,50);
    
    $this->SetFont('times', 'B', 13);
    
    $this->Text(75, 15, utf8_decode('REPORTE FINANCIERO PERSONAL'));
    ...
    $this->Image('../../images/fondo_blin.png',160,5,50);
...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("BLIN-NP © Todos los derechos reservados."),0,0,"C");
