...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li> Antecedente</li>
        <li class="active">Lista de Antecedente</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
               <a href="#antecedentes" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nuevo</a>
            </div>
            <div class="box-body">
             <!-- Tabla para mostrar los datos de la tabla disciplinarios -->
                ...
                <tbody>
                    ...
                    $sql = "SELECT *, id AS empid FROM disciplinarios";
  ...
  <?php include 'includes/antecedentes_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'antecedentes_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('#edit_infraccion').val(response.infraccion);
      $('#edit_correctivo').val(response.correctivo);
      $('#edit_fecha').val(response.fecha);
      $('#edit_obs').val(response.obs);
